...
Function that takes airline data as input and create 5 data-frames based on the grouping condition to be used for 
...
Returns:
    Computed average data-frames for carrier delay, weather delay, NAS delay, security delay, and late aircraft delay.
"""
...
app.layout = html.Div(children=[html.H1('US Domestic Airline Flights Performance',
                                ...
                                html.Div([
                                    # Add a division
                                    html.Div([
                                        # Create an division for adding drop-down helper text for report type
                                    ...
                                    # Add next division
                                    html.Div([
                                        # Create an division for adding drop-down helper text for choosing year
                                        html.Div(
                                            [
                                        ...
                                        dcc.Dropdown(id='input-year',
                                                     # Update drop-down values using list comprehension
                                ...
                                # Observe how we add an empty division and providing an
                                # id that will be updated during callback
                                html.Div([], id='plot1'),
...
@app.callback([Output(component_id='plot1', component_property='children'),
              ...
              # Holding output state till user enters all the form information. In this case, it will be
              # chart type and year
